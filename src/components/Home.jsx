  ...
  return (
    <section className='mx-auto px-4 py-2 flex flex-col justify-center items-center md:items-start md:flex-row md:gap-4 lg:gap-10 md:mt-4'>
      <div className='mx-auto flex flex-col items-center'>
        <h1 className='font-amatic text-3xl text-transform: uppercase font-bold md:mb-20'>
      ...
      <article className='md:w-4/6 space-y-4'>
        <p className='px-2'>
          I'm Agnieszka Wilczek, an enthusiastic junior developer on a journey
          into the fascinating world of web development. My adventure began with
          HTML and CSS, where I cultivated my skills in crafting visually
        ...
        <p className='px-2 bg-bg-opacity rounded-md'>
          ...
          I'm still in the early stages of my coding expedition, each line of
          code I write is fueled by a genuine passion for learning and building.
        </p>

        <p className='px-2'>
          My current toolkit includes HTML, CSS, JavaScript and React, and I'm
          eagerly absorbing new concepts like a sponge. My goal is to transition
          from frontend to full-stack development, embracing the challenges and
